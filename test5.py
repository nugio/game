...
#ファイルパスの指定
root_path ="C:\\Users\\PC\\Documents\\python\\game\\sozai\\"
frog_path = root_path + "bubblefrog.png"
frogitem_path = root_path + "frog.png"
obake_path = "C:\\Users\\PC\\Documents\\python\\game\\sozai\\bubbleobake.png"
obakeitem_path = "C:\\Users\\PC\\Documents\\python\\game\\sozai\\obake.png"
asiato_path = "C:\\Users\\PC\\Documents\\python\\game\\sozai\\bubbleasiato.png"
asiatoitem_path = "C:\\Users\\PC\\Documents\\python\\game\\sozai\\asiato.png"
hana_path = "C:\\Users\\PC\\Documents\\python\\game\\sozai\\bubblehana.png"
hanaitem_path = "C:\\Users\\PC\\Documents\\python\\game\\sozai\\hana.png"
sun_path = "C:\\Users\\PC\\Documents\\python\\game\\sozai\\bubblesun.png"
sunitem_path = "C:\\Users\\PC\\Documents\\python\\game\\sozai\\sun.png"
...
def main():
    ...
    while True:
        ...
        spendtime = int(time.time() - starttime)
        ...
        if Task.taskcount == [0,0,0,0,0]:
            ...
            text_clear = font2.render("やったね！", True, (250,50,50))
            screen.blit(text_clear, (400,400))
            stagecount +=1
            cleartime = int(time.time() - starttime)
...
class Player(pygame.sprite.Sprite):
    #"""自機"""
    speed = 3  # 初期移動速度
    reload_time = 150 # リロード時間
    reload_timer = 0
    first_bullet = 7 #初期弾数
    bullet_count = 0
    zero_reload = 600 #残弾切れ時リロード時間
    stepforward = 0
...
class Target(pygame.sprite.Sprite):
     ...
     def update(self):
         ...
         if self.rect.top > int(sc_h*1/2) or self.rect.top < 0:
